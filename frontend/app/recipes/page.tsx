            ...
            <div className="space-y-4">
              <div className="flex items-start justify-between gap-4 border-b border-slate-100 pb-4">
                <div>
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-wider text-[#0f2942] bg-slate-100 px-2 py-0.5 rounded-md border border-slate-200 inline-block mt-1">
                ...
                <div className="text-right">
                  ...
                  <span className="font-serif text-2xl font-bold text-[#b48324]">
              ...
              <div className="grid grid-cols-2 gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200 text-xs">
                ...
                <div>
                  ...
                  <span className="font-bold text-[#064e3b] text-sm mt-0.5 block">
              ...
              <div>
                <h4 className="text-[11px] font-bold uppercase tracking-wider text-slate-500 mb-2 flex items-center gap-1.5">
                  <Layers className="w-3.5 h-3.5 text-[#b48324]" />
